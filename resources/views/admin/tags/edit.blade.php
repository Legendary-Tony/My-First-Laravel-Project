						...
						<form method="POST" action="{{ route('tags.update', $tags->id) }}" >
							...
							<div class="col-lg-offset-3 col-lg-6 col-sm-6 col-md-6">
								...
								<div class="form-group">
									<input value="{{$tags->name}}" class="form-control" type="text" name="name" placeholder="Tag Title">
								</div>

								<label>Tags slug</label>
								<div class="form-group">
									<input value="{{$tags->slug}}" class="form-control" type="text" name="slug" placeholder="Tag Slug">
								</div>
